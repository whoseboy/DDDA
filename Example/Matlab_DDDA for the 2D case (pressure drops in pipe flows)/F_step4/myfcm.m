function [center, U, obj_fcn] = myfcm(data, cluster_n, center_initi, options)
% center_initi is estimated by the function "subclust"
...
% the initial matrix is constructed by the center_initi
dist_initi=distfcm(center_initi,data);
tmp_initi=dist_initi.^(-2/(expo-1));     
U = tmp_initi./(ones(cluster_n, 1)*sum(tmp_initi));
